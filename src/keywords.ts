// according to https://dev.mysql.com/doc/refman/8.0/en/keywords.html
...
const extractingRegex = new RegExp(
...
const extractKeywords = (str: string): string[] => {
  ...
  const matches = Array.from(str.matchAll(extractingRegex));
  for (const match of matches) {
    uniqWords.add(match[0]);
  }

  return Array.from(uniqWords);
};

export { keywordsMap, regexMap, sqlKeyWords, extractKeywords, extractingRegex };
